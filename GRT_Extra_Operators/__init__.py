...
modules = [
    GRT_Reset_Bake_Settings_To_Default,
    GRT_Proximity_Parent,
    GRT_Batch_Rename_Vertex_Groups,
    GRT_Unbind,
    GRT_Convert_Bendy_Bones_To_Bones,
    GRT_Disconnect_All_Bones,
    GRT_Flatten_Hierarchy,
    GRT_Unlock_Bones_Transform,
    ...
    GRT_Remove_Custom_Property,
    GRT_Remove_Non_Deform_Bone,
]
